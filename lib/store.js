...
var Store = {
  ...
  create(spec) {
    ...
    if (!!spec.addChangeListener) {
      throw new Error('Overwriting of MinFlux.Store.addChangeListener not allowed');
    }

    if (!!spec.removeChangeListener) {
      throw new Error('Overwriting of MinFlux.Store.removeChangeListener not allowed');
    }

    if (!!spec.emitChange) {
      throw new Error('Overwriting of MinFlux.Store.emitChange not allowed');
    }
